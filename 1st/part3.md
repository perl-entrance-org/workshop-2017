...
- Perl 5とは別に, Perl 6も開発されています.
    ...
    - 現在の最新の安定版は5.26.0(2017年7月現在), バージョンを確認する `perl -v` では, Perl5のバージョン26, のように表記されています.
...
___
## 練習問題 (2)
- `print 5-2;` とすると3が表示されます(ダブルクォートはしません). では, 2017からPerl1.0のリリース年の西暦を引き算して,Perlの満年齢を表示してみましょう.
